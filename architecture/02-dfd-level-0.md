...
| F5 | Mitra (master) | 0 | Mitra identity, vehicle, capacity, routes, area coverage, contact, tariff | Loaded once at startup from a JSON file; afterwards read-only master data. |
...
transfers, TSO orders, invoice generation, audit logging, the SQLite database.
